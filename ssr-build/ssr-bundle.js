...
var rnd = function rnd(_ref) {
  var start = _ref[0],
      end = _ref[1];
  return (Math.random() * (end - start) | 0) + start;
};
var rndEmoji = function rndEmoji() {
  var count = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
  var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'face';
  return new Array(count).fill().map(function (x) {
    return String.fromCodePoint(rnd(emojis[type]));
  });
};

var _Demo = function _Demo(props, _ref2) {
  var setGlobal = _ref2.setGlobal,
      globals = _objectWithoutProperties(_ref2, ['setGlobal']);

  var _rndEmoji = rndEmoji(2),
      l = _rndEmoji[0],
      r = _rndEmoji[1];

  return Object(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
    'div',
    { style: { textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', fontSize: 50 } },
    Object(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      ...
      Object(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'button',
        { style: { fontSize: 20 }, onClick: function onClick(e) {
            return setGlobal('whatever', l + ' COOL! ' + r);
          } },
        'COOL IT'
      )
    ),
    Object(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      'a',
      { href: 'https://github.com/konsumer/preact-globals' },
      Object(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('img', { style: { position: 'absolute', top: 0, left: 0, border: 0 }, src: 'https://s3.amazonaws.com/github/ribbons/forkme_left_darkblue_121621.png', alt: 'Fork me on GitHub' })
    )
  );
};
